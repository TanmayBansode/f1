...
export default memo(function BottomBar({
  ...
  return (
    <div className="bg-[#0d0d0d] border-t border-neutral-800/40 z-40">
      {/* Row 1: Controls */}
      <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-1.5 sm:py-2.5">
        {/* Collapse toggle */}
        <button
          onClick={onToggle}
      ...
      <div className="flex items-center gap-2 px-2 sm:px-4 pb-2 sm:pb-2.5">
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${full ? `${team.color}80` : partial ? `${team.color}40` : "#222"}`,
                  padding: teamShowLogo ? "2px" : "3px 8px",
                  width: teamShowLogo ? 38 : "auto",
                  height: teamShowLogo ? 24 : "auto",
